<article class="col-sm-8 view-wallet-content">
  ...
  <section class="block">
    <div class="col-xs-12">
      ...
      <input class="form-control" type="text" ng-value="wallet.getAddressString()" readonly="readonly">
    </div>
  ...
  <section class="block">
    <div class="col-xs-6">
      <h5 translate="x_Address">Your Address:</h5>
      <div class="qr-code" qr-code="{{wallet.getQrAddressString()}}" watch-var="wallet" width="100%"></div>
    </div>
    <div class="col-xs-6">
